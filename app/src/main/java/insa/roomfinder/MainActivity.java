...
public class MainActivity extends ActionBarActivity
    ...
    public void onNavigationDrawerItemSelected(int position) {
        ...
        if(position == 0){
            fragmentManager.beginTransaction()
                    .replace(R.id.container, Favorite.newInstance(position + 1))
                    .commit();
        }
        else if(position == 1) {
            fragmentManager.beginTransaction()
                    .replace(R.id.container, Search.newInstance(position + 1))
                    .commit();
        }
        else if(position==2){
            fragmentManager.beginTransaction()
                    .replace(R.id.container, Profile.newInstance(position + 1))
                    .commit();
        }
        else if(position==3) {
            fragmentManager.beginTransaction()
    ...
    public static class Result extends Fragment {
        /**
         * The fragment argument representing the section number for this
         * fragment.
         */
         ...
         * number.
         */
        public static Result newInstance(int sectionNumber) {
